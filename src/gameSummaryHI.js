  ...
  return (
    ...
    <Accordion style={paperStyle}>
      <AccordionSummary expandIcon={<VerticalAlignBottomTwoToneIcon />}>
        ...
        <Typography style={{fontWeight: "bold", width: '50%', flexShrink: 0, textAlign: "right"}}>{match.playedAt}</Typography>
      </AccordionSummary>
      <AccordionDetails>
          ...
          <Grid item xs>
            ...
            <List>
              { kills.map((obj, index) => {
                ...
                return(
                  <ListItem key={index}>
                    <Paper elevation={2} style={{padding: 5, width: "100%", background: "#4F7942"}}>
